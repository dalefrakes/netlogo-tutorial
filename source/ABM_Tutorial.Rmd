---
title: "Tutorial:  Intro to Agent-Based Modeling (ABM) through Modeling Mass Opinion Dynamics"
output:
...
* Paper: _Extremism without extremists: Deffuant model with emotions_ (Pawel Sobkowicz) <https://www.frontiersin.org/articles/10.3389/fphy.2015.00017/full>
...
![](./img/04-simple-global-threshold.png)
...
![](./img/05-simple-global-threshold-plot.png)
...
Which will give us somthing like this:
![](./img/05-simple-global-threshold-plot-b.png)
...
And the corresponding code block looks like this.
`r  filename <- '06-with_probability_distributions.nlogo'`
**File: `r filename`:**
```{r comment='', echo=FALSE}
show_netlogo_file(filename)
```
