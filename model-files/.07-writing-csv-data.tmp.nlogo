...
to setup
  ...
  [
    ...
    if behaviorspace-run-number <= 1 [
      ...
      ;  file-print (word  behaviorspace-run-number ",  " ticks ", " who ", " opinion ", " threshold )
      file-print (word "run-number" ", "  "ticks" ", " "who" ", " "opinion" ", " "threshold" )
    ]
  ]
...
<experiments>
  <experiment name="experiment 1" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="dist-scale">
      <value value="0.45"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-opinion-dist">
      <value value="&quot;normal&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="convergence-u">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="population">
      <value value="500"/>
    </enumeratedValueSet>
    <steppedValueSet variable="threshold" first="0" step="1" last="0.1"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
